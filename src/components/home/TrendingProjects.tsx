...
export const TRENDING_PROJECTS_QUERY = gql(`
...
export default async function TrendingProjects() {
  ...
  const projects = data?.trendingProjects?.projects ?? [];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-1">
              Trending Projects in Bengaluru
            </h2>
            <p className="text-sm text-gray-600">
              Discover the most popular projects in your area
            </p>
          </div>
          <Link
            href="/properties?trending=true"
        ...
        {!projects.length ? (
          <div className="rounded-lg border border-dashed border-gray-200 bg-white p-6 text-center text-gray-600">
            Trending projects will appear here once they are available.
          </div>
        ) : (
